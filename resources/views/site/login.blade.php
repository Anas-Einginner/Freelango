...
<head>
    ...
    <link href="{{asset('website_asset/css/app.css')}}" rel="stylesheet">
    <link href="{{asset('website_asset/css/pages.css')}}" rel="stylesheet">
    <link href="{{asset('website_asset/css/responsive.css')}}" rel="stylesheet">
</head>
<body>
    <nav class="navbar">
    ...
    {{-- <script src="website_asset/js/app.js"></script> --}}
