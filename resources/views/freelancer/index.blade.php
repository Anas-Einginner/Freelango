...
<head>
  ...
  <!-- loader-->
	<link href="{{('dashboard_asset/assets/css/pace.min.css')}}" rel="stylesheet" />
...
<body>
  ...
  <!-- Bootstrap bundle JS -->
  <script src="{{('dashboard_asset/assets/js/bootstrap.bundle.min.js')}}"></script>
  <!--plugins-->
  <script src="{{('dashboard_asset/assets/js/jquery.min.js')}}"></script>
  <script src="{{('dashboard_asset/assets/plugins/simplebar/js/simplebar.min.js')}}"></script>
  <script src="{{('dashboard_asset/assets/plugins/metismenu/js/metisMenu.min.js')}}"></script>
  <script src="{{('dashboard_asset/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js')}}"></script>
  <script src="{{('dashboard_asset/assets/js/pace.min.js')}}"></script>
  <script src="{{('dashboard_asset/assets/plugins/chartjs/js/Chart.min.js')}}"></script>
  <script src="{{('dashboard_asset/assets/plugins/chartjs/js/Chart.extension.js')}}"></script>
  <script src="{{('dashboard_asset/assets/plugins/apexcharts-bundle/js/apexcharts.min.js')}}"></script>
  <!--app-->
  <script src="{{('dashboard_asset/assets/js/app.js')}}"></script>
  <script src="{{('dashboard_asset/assets/js/index.js')}}"></script>
  <script>
