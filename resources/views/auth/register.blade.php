                            ...
                            <div class="form-group">
                                ...
                                <div class="categories-grid">
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="webDev" value="webDev">
                                        <label for="webDev">تطوير الويب</label>
                                    </div>
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="mobileApp" value="mobileApp">
                                        <label for="mobileApp">تطبيقات الموبايل</label>
                                    </div>
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="graphicDesign" value="graphicDesign">
                                        <label for="graphicDesign">تصميم جرافيك</label>
                                    </div>
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="contentWriting"
                                            value="contentWriting">
                                        <label for="contentWriting">كتابة المحتوى</label>
                                    </div>
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="marketing" value="marketing">
                                        <label for="marketing">التسويق الرقمي</label>
                                    </div>
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="translation" value="translation">
                                        <label for="translation">الترجمة</label>
                                    </div>
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="videoEditing" value="videoEditing">
                                        <label for="videoEditing">مونتاج الفيديو</label>
                                    </div>
                                    <div class="category-item">
                                        <input name="skills[]" type="checkbox" id="seo" value="seo">
