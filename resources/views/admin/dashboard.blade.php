...
<head>
  ...
  <link rel="icon" href="{{asset('dashboard_asset/images/favicon-32x32.png')}}" type="image/png')}}" />
  <!--plugins-->
  <link href="{{asset('dashboard_asset/plugins/simplebar/css')}}/simplebar.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/plugins/perfect-scrollbar/css')}}/perfect-scrollbar.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/plugins/metismenu/css')}}/metisMenu.min.css')}}" rel="stylesheet" />
  <!-- Bootstrap css')}} -->
  <link href="{{asset('dashboard_asset/css/bootstrap.min.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/css/bootstrap-extended.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/css/style.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/css/icons.css')}}" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css')}}2?family=Roboto:wght@400;500&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
  

  <!-- loader-->
	<link href="{{('dashboard_asset/css/pace.min.css')}}" rel="stylesheet" />

  <!--Theme Styles-->
  <link href="{{asset('dashboard_asset/css/dark-theme.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/css/light-theme.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/css/semi-dark.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard_asset/css/header-colors.css')}}" rel="stylesheet" />
...
<body>
              ...
              <li class="nav-item dropdown dropdown-user-setting">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div class="user-setting d-flex align-items-center">
                    <img src="{{asset('dashboard_asset/images/avatars/avatar-1.png')}}" class="user-img" alt="">
                  </div>
                </a>
                  ...
                  <li>
                     <a class="dropdown-item" href="#">
                       <div class="d-flex align-items-center">
                          <img src="{{asset('dashboard_asset/images/avatars/avatar-1.png')}}" alt="" class="rounded-circle" width="54" height="54">
                          <div class="ms-3">
              ...
              <li class="nav-item dropdown dropdown-large">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0">
                 ...
                 <div class="header-message-list p-2">
                     <a class="dropdown-item" href="#">
                       <div class="d-flex align-items-center">
                          <img src="{{asset('dashboard_asset/images/avatars/avatar-1.png')}}" alt="" class="rounded-circle" width="50" height="50">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('dashboard_asset/images/avatars/avatar-2.png')}}" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('dashboard_asset/images/avatars/avatar-3.png')}}" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('dashboard_asset/images/avatars/avatar-4.png')}}" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('dashboard_asset/images/avatars/avatar-5.png')}}" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="{{asset('dashboard_asset/images/avatars/avatar-6.png')}}" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
       ...
       <!--end top header-->
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          <div class="sidebar-header">
            <div>
              <img src="{{asset('dashboard_asset/images/logo-icon.png')}}" class="logo-icon" alt="logo icon">
            </div>
            <div>
  ...
  <!-- Bootstrap bundle JS -->
  <script src="{{('dashboard_asset/js/bootstrap.bundle.min.js')}}"></script>
  <!--plugins-->
  <script src="{{('dashboard_asset/js/jquery.min.js')}}"></script>
  <script src="{{('dashboard_asset/plugins/simplebar/js/simplebar.min.js')}}"></script>
  <script src="{{('dashboard_asset/plugins/metismenu/js/metisMenu.min.js')}}"></script>
  <script src="{{('dashboard_asset/plugins/perfect-scrollbar/js/perfect-scrollbar.js')}}"></script>
  <script src="{{('dashboard_asset/js/pace.min.js')}}"></script>
  <script src="{{('dashboard_asset/plugins/chartjs/js/Chart.min.js')}}"></script>
  <script src="{{('dashboard_asset/plugins/chartjs/js/Chart.extension.js')}}"></script>
  <script src="{{('dashboard_asset/plugins/apexcharts-bundle/js/apexcharts.min.js')}}"></script>
  <!--app-->
  <script src="{{('dashboard_asset/js/app.js')}}"></script>
  <script src="{{('dashboard_asset/js/index.js')}}"></script>
  <script>
